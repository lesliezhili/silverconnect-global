...
export default async function HelpArticlePage({
  ...
  return (
    <>
      ...
      >
        <p className="text-[16px] font-semibold uppercase tracking-wider text-brand">
        ...
        <Link
          href="/help"
          className="mt-8 inline-flex h-12 items-center text-[17px] font-semibold text-brand"
        >
          ← {t("backToHelp")}
        </Link>
      </main>
