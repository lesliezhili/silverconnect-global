      ...
      >
        ...
        <div className="mt-4 flex items-start gap-2.5 rounded-md border-[1.5px] border-danger bg-danger-soft p-3.5">
          ...
          <div className="text-danger">
            <p className="text-[17px] font-bold">{t("sevHighDivertTitle")}</p>
            <p className="mt-0.5 text-[16px]">{t("sevHighDivertHint")}</p>
            <Link
              href="/chat?emergency=1"
              className="mt-2 inline-flex h-12 items-center rounded-md bg-danger px-5 text-[17px] font-bold text-white"
            >
              {t("openSos")}
            </Link>
          </div>
        ...
        <form action={reportAction} className="mt-6 flex flex-col gap-6">
          ...
          <div>
            ...
            <p
              id="describe-hint"
              className="mt-1.5 text-[17px] text-text-tertiary"
            >
              {t("describeHint")}
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="block w-full text-[16px] text-text-secondary opacity-50 file:mr-3 file:inline-flex file:h-12 file:items-center file:rounded-md file:border-[1.5px] file:border-border-strong file:bg-bg-base file:px-4 file:text-[16px] file:font-semibold file:text-text-primary"
            />
            <p className="mt-1.5 flex items-center gap-1 text-[17px] text-text-tertiary">
          ...
          <label className="flex items-center gap-3 rounded-md border-[1.5px] border-border bg-bg-base p-4 has-[:checked]:border-brand">
            ...
            <span
              ...
              aria-hidden
            />
            <span className="text-[17px]">{t("policeContacted")}</span>
          </label>
