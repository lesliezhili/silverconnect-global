      ...
      <>
        ...
        >
          {offline && (
            ...
            >
              <p className="text-[#92590A] dark:text-[var(--brand-accent)] text-[16px] font-semibold">
                {t("currentlyOffline")}
              </p>
            </div>
          )}
            ...
            <div className="min-w-0 flex-1">
              ...
              <ul className="mt-2 flex flex-wrap gap-1.5">
                ...
                {badges.slice(0, 3).map((b) => (
                  <li key={b.kind}>
                    <span className="inline-flex h-7 items-center rounded-sm bg-brand-soft px-2 text-[16px] font-semibold text-brand">
                      {b.kind}
                    </span>
                  </li>
                ))}
                {categoryCodes.slice(0, 3).map((c) => (
                  <li key={c}>
                    <span className="inline-flex h-7 items-center rounded-sm bg-bg-surface-2 px-2 text-[17px] font-semibold text-text-secondary">
          ...
          <section className="mt-6">
            ...
            {servicesOffered.length === 0 ? (
              <p className="rounded-md border border-border bg-bg-base p-3.5 text-[16px] text-text-secondary">
                {isZh
                  ? "该服务者暂无可提供的服务。"
                  ...
                  <li key={s.id}>
                    <div className="flex min-h-16 items-center gap-3 rounded-md border-[1.5px] border-border bg-bg-base p-3.5">
                      <span className="min-w-0 flex-1">
                        ...
                        <span className="mt-0.5 block text-[17px] text-text-tertiary">
                          {s.code}
                        </span>
                      </span>
          ...
          <section className="mt-6">
            ...
            {reviewCount === 0 ? (
              <div className="rounded-md border border-border bg-bg-base p-6 text-center">
                ...
                <p className="mt-1 text-[17px] text-text-tertiary">
                  {t("noReviewsHint")}
                </p>
              </div>
            ) : (
                    ...
                    {[5, 4, 3, 2, 1].map((n) => {
                      ...
                      return (
                        <div key={n} className="mb-0.5 flex items-center gap-1.5">
                          <span className="w-3 text-[16px] text-text-tertiary tabular-nums">
                            {n}
                          </span>
                          <Star
                            size={12}
                ...
                <ul className="mt-3 flex flex-col gap-3">
                  {recent.map((r) => (
                    ...
                    >
                      ...
                      <p className="mt-1.5 text-[16px] text-text-tertiary">
