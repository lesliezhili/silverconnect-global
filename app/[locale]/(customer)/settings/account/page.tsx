      ...
      <main id="main-content" className="mx-auto w-full max-w-content px-5 pb-[120px] pt-6 sm:pb-12">
        ...
        <form action={saveAccount} className="mt-5 flex flex-col gap-4">
          ...
          <div>
            ...
            <select id="ccy" name="ccy" defaultValue={country === "CN" ? "CNY" : country === "CA" ? "CAD" : country === "US" ? "USD" : country === "TW" ? "TWD" : country === "SG" ? "SGD" : country === "HK" ? "HKD" : country === "MY" ? "MYR" : "AUD"} className={fieldClass}>
