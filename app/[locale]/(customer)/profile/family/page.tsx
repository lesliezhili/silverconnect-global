...
export default async function FamilyPage({
  ...
  try {
      ...
      <>
        ...
        >
          ...
          <ul className="mt-3 flex flex-col gap-2">
            ...
            <li className="flex items-center gap-3 rounded-lg border border-border bg-bg-base p-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[17px] font-bold">
                  {me.name || me.email}
                  <span className="ml-2 text-[16px] font-semibold text-text-tertiary">
                    · {t("self")}
                  </span>
                </p>
                ...
                <div className="mt-1 flex flex-wrap gap-2 text-[16px]">
            ...
            {members.map((m) => (
              ...
              >
                ...
                />
                <div className="min-w-0 flex-1">
                  <p className="text-[17px] font-bold">{m.name}</p>
                  <p className="text-[16px] text-text-tertiary tabular-nums">
                    {m.email}
                  </p>
                  <div className="mt-1 flex flex-wrap gap-2 text-[16px]">
                ...
                <form action={removeAction}>
                  ...
                  <button
                    type="submit"
                    aria-label={t("revoke")}
                    className="inline-flex h-12 w-10 items-center justify-center rounded-sm border-[1.5px] border-danger text-danger"
                  >
          ...
          >
            ...
            <label className="inline-flex items-center gap-2 text-[16px] text-text-secondary">
    ...
    console.error("[family] DB unavailable", error);
    return (
