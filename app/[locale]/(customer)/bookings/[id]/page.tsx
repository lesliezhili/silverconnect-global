...
export default async function BookingDetailPage({
  ...
  try {
    ...
    const cancelBar =
      status === "confirmed" ? (
        <p className="flex items-center gap-2 rounded-md bg-brand-soft px-3.5 py-3 text-[16px] text-brand">
          <Clock size={16} aria-hidden /> {t("cancelFreeUntil", { hours: 47 })}
        </p>
      ) : status === "in_progress" ? (
        <p className="rounded-md bg-warning-soft px-3.5 py-3 text-[16px] text-[#92590A]">
      ...
      <>
        ...
        >
          <div className="mb-4 flex items-center gap-2">
            ...
            <span className="text-[17px] text-text-tertiary">
              #{row.id.slice(0, 8)}
            </span>
          </div>
            ...
            <ul className="mt-3 flex flex-col gap-2">
              <li className="flex items-center gap-2.5">
                <Calendar
                  ...
                  aria-hidden
                />
                <span className="text-[17px]">{whenLabel}</span>
              </li>
              {addressStr && (
                <li className="flex items-center gap-2.5">
                  <MapPin
                    ...
                    aria-hidden
                  />
                  <span className="text-[17px]">{addressStr}</span>
                </li>
              )}
              <li className="flex items-center gap-2.5">
                <CreditCard
          ...
          {(status === "confirmed" ||
            ...
            <Link
              ...
              className="mt-5 block text-center text-[17px] font-semibold text-danger underline-offset-4 hover:underline"
            >
