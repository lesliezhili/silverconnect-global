...
export default async function DisputePage({
  ...
  return (
      ...
      >
        ...
        <div className="mt-4 flex items-start gap-2.5 rounded-md border-[1.5px] border-warning bg-warning-soft p-3.5">
          ...
          <div className="text-[#92590A] dark:text-[var(--brand-accent)]">
            <p className="text-[17px] font-bold">{t("noticeTitle")}</p>
            <p className="mt-0.5 text-[16px]">{t("noticeHint")}</p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              multiple
              className="block w-full text-[16px] text-text-secondary file:mr-3 file:inline-flex file:h-12 file:items-center file:rounded-md file:border-[1.5px] file:border-border-strong file:bg-bg-base file:px-4 file:text-[16px] file:font-semibold file:text-text-primary"
            />
    ...
    console.error("[dispute] DB unavailable", error);
    return (
