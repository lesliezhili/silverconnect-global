...
interface Series {
  id: string;
  serviceKey: "cleaning" | "companion" | "garden" | "personalCare" | "repair";
  providerName: string;
    ...
    <>
      ...
      <main id="main-content" className="mx-auto w-full max-w-content px-5 pb-[120px] pt-6 sm:pb-12">
        ...
        {MOCK.length === 0 ? (
          ...
          <>
            <p className="mt-4 text-[17px] text-text-tertiary tabular-nums">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-0.5 text-[17px] font-semibold text-brand">
                          {t(s.cadence)}
                        </p>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <button
                        type="button"
                        className="inline-flex h-12 items-center gap-1 rounded-sm border-[1.5px] border-border-strong bg-bg-base px-3 text-[17px] font-semibold text-text-primary"
                      >
                      ...
                      <button
                        type="button"
                        className="ml-auto inline-flex h-12 items-center gap-1 rounded-sm border-[1.5px] border-danger bg-bg-base px-3 text-[17px] font-semibold text-danger"
                      >
