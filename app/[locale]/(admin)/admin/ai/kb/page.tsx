...
export default async function AdminKbPage({
  ...
  try {
    ...
    return (
      <AdminShell email={admin.email ?? ""}>
        <div className="flex items-center justify-between">
          ...
          <a
            href="?add=1"
            className="inline-flex h-12 items-center gap-2 rounded-md bg-brand px-3 text-[17px] font-bold text-white"
          >
        ...
        {sp.saved === "1" && (
          <div
            role="status"
            className="mt-3 rounded-md bg-success-soft px-3.5 py-2.5 text-[17px] font-semibold text-success"
          >
            {tA("kbSaved")}
          </div>
        )}
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="min-w-0 flex-1">
                    <p className="text-[17px] font-bold">{e.question}</p>
        ...
        {adding && (
          ...
          >
            ...
            <div>
              ...
              />
              <p id="kb-var-hint" className="mt-1.5 text-[16px] text-text-tertiary">
                {tA("kbVarHint")}
              </p>
            </div>
    ...
    console.error("[kb] DB unavailable", error);
    return (
