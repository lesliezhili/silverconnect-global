...
export default async function AdminCustomersPage({
  ...
  try {
    ...
    console.error("[customers] DB unavailable", error);
    return (
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 px-5 py-5">
          <dl className="grid grid-cols-[120px_1fr] gap-y-2 text-[16px]">
          ...
          <Link
            ...
            className="mt-5 inline-flex h-12 items-center rounded-sm border-[1.5px] border-brand bg-bg-base px-3 text-[17px] font-semibold text-brand"
          >
            {tC("viewFull")}
          </Link>
