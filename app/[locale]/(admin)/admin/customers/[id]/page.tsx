    ...
    return (
      <AdminShell email={admin.email ?? ""}>
        ...
        <section className="mt-5 rounded-lg border border-border bg-bg-base p-4">
          <p className="text-[16px] font-bold">{tD("bookings")}</p>
        ...
        <section className="mt-5 rounded-lg border border-border bg-bg-base p-4">
          <p className="text-[16px] font-bold">Reviews given</p>
        ...
        <section className="mt-5 grid grid-cols-2 gap-3">
          <div className="rounded-lg border border-border bg-bg-base p-4">
            <p className="text-[16px] text-text-tertiary">Addresses</p>
            <p className="mt-1 text-[22px] font-extrabold tabular-nums">
              {addressCount}
            </p>
          </div>
          <div className="rounded-lg border border-border bg-bg-base p-4">
            <p className="text-[16px] text-text-tertiary">Emergency contacts</p>
            <p className="mt-1 text-[22px] font-extrabold tabular-nums">
              {emergencyCount}
            </p>
          </div>
        ...
        <p className="mt-6 rounded-md bg-bg-surface-2 px-3.5 py-3 text-[17px] text-text-tertiary">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {(["suspend", "resume", "ban"] as const).map((k) => (
            <button
              ...
              type="button"
              disabled
              className="inline-flex h-12 items-center rounded-md border-[1.5px] border-border bg-bg-base px-4 text-[16px] font-bold text-text-tertiary opacity-60"
            >
              {tD(k)}
            </button>
          ))}
