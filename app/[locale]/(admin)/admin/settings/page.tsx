      ...
      <AdminShell email={admin.email ?? ""}>
        ...
        <form action={saveSettings} className="mt-5 flex flex-col gap-5">
          ...
          <section className="rounded-lg border border-border bg-bg-base p-4">
            <p className="text-[17px] font-bold">{tA("feeRates")}</p>
          ...
          <section className="rounded-lg border border-border bg-bg-base p-4">
            <Label htmlFor="cancelHours" className="text-[17px] font-bold">
              {tA("cancelWindow")}
            </Label>
            <div className="mt-3">
              <Input
          ...
          <section className="rounded-lg border border-border bg-bg-base p-4">
            <Label htmlFor="kw" className="text-[17px] font-bold">
              {tA("emergencyKw")}
            </Label>
            <textarea
              id="kw"
              ...
              readOnly
              className="mt-3 block w-full rounded-md border-[1.5px] border-border-strong bg-bg-surface-2 p-3 text-[16px] text-text-secondary"
            />
            <p id="kw-hint" className="mt-1.5 text-[16px] text-text-tertiary">
          ...
          <section className="rounded-lg border border-border bg-bg-base p-4">
            <p className="text-[17px] font-bold">{tA("admins")}</p>
            {adminUsers.length === 0 ? (
              <p className="mt-3 text-[17px] text-text-tertiary">—</p>
            ) : (
          ...
          <section className="rounded-lg border border-border bg-bg-base p-4">
            <p className="text-[17px] font-bold">{tA("auditLog")}</p>
            {recentAudit.length === 0 ? (
              <p className="mt-2 text-[17px] text-text-tertiary">—</p>
            ) : (
              <ul className="mt-2 flex flex-col gap-1 text-[17px] text-text-tertiary">
                {recentAudit.map((a, i) => (
