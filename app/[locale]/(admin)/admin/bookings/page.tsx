  ...
  try {
    ...
    return (
      <AdminShell email={admin.email ?? ""}>
        ...
        <p className="mt-1 text-[17px] text-text-secondary">{tB("sub")}</p>
          ...
          {rows.map((b) => {
            ...
            return (
              ...
              >
                ...
                <span className="hidden text-[16px] text-text-tertiary tabular-nums sm:inline">
                  {tB("minutesAgo", { n: min })}
                </span>
              </li>
            );
    ...
    console.error("[bookings] DB unavailable", error);
    return (
