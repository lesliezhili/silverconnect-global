          ...
          {filters.map((f) => {
            ...
            return (
              <Link
                ...
                aria-selected={on}
                className={
                  "inline-flex h-12 items-center gap-1 rounded-pill border-[1.5px] px-4 text-[16px] font-semibold tabular-nums " +
                  (on
                ...
                >
                  ...
                  {reply ? (
                    <div className="mt-3 rounded-md bg-bg-surface-2 p-3">
                      <p className="text-[16px] font-bold text-text-secondary">
                        {t("reviewsReplied")}
                      </p>
                      <p className="mt-0.5 text-[17px] text-text-primary">
                        {reply}
                      </p>
                    </div>
                  ) : (
