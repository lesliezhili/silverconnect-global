      ...
      >
        ...
        <div className="mt-8 rounded-lg border border-border bg-bg-base p-4">
          ...
          <Link
            ...
            className="mt-3 inline-flex h-12 items-center rounded-md border-[1.5px] border-brand bg-bg-base px-5 text-[17px] font-bold text-brand"
          >
            {t("docUpload")}
          </Link>
        </div>
    ...
    <li className="grid grid-cols-[40px_1fr] gap-3">
      <div className="flex flex-col items-center">
        <span
          aria-hidden
          className={
            "flex h-12 w-10 shrink-0 items-center justify-center rounded-full " +
            colorClass
          }
        >
      ...
      <div className={"pb-6 " + (last ? "" : "border-b border-transparent")}>
        ...
        <p className="mt-0.5 text-[17px] font-semibold text-text-secondary">
          {stateLabel}
