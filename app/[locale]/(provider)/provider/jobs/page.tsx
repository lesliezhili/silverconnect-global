...
export default async function ProviderJobsPage({
  ...
  return (
          ...
          {tabs.map((tb) => {
            ...
            return (
              <Link
                ...
                aria-selected={on}
                className={
                  "inline-flex h-12 items-center rounded-pill border-[1.5px] px-4 text-[16px] font-semibold " +
                  (on
                ...
                <li key={j.id}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-[17px] font-semibold uppercase tracking-wide text-text-tertiary tabular-nums">
                        {dateLabel} · {timeLabel}
                      </p>
                      ...
                      <p className="mt-1 flex items-center gap-1 text-[17px] text-text-tertiary">
    ...
    console.error("[jobs] DB unavailable", error);
    return (
      <main className="mx-auto w-full max-w-content px-5 py-12 text-center">
        <p className="text-[48px]">⏳</p>
        <h1 className="mt-4 text-elder-subheading font-bold">Service Temporarily Unavailable</h1>
