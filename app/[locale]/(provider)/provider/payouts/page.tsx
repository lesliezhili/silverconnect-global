      ...
      >
        ...
        <section className="mt-5 flex items-start gap-3 rounded-lg border border-border bg-bg-base p-4">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[17px] font-bold">{t("payoutsAccount")}</p>
            <p className="mt-0.5 text-[16px] font-semibold text-success">
              {t("payoutsAccountActive")}
            </p>
            <button
              type="button"
              className="mt-2 inline-flex h-12 items-center rounded-sm border-[1.5px] border-border-strong bg-bg-base px-3 text-[17px] font-semibold text-text-primary"
            >
              {t("payoutsReverify")}
            </button>
          </div>
        ...
        >
          ...
          <fieldset>
            <legend className="text-[17px] font-bold">{t("payoutsFreq")}</legend>
        ...
        <section className="mt-5">
          <p className="text-[17px] font-bold">{t("payoutsHistory")}</p>
          <ul className="mt-3 overflow-hidden rounded-lg border border-border bg-bg-base">
            {MOCK_PAYOUTS.map((p, i) => (
              ...
              >
                <span
                  aria-hidden
                  className="flex h-12 w-10 shrink-0 items-center justify-center rounded-md bg-success-soft text-success"
                >
