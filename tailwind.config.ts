  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // Elder-First Design System (60+ users)
        "elder-small": ["18px", { lineHeight: "1.4" }],
        "elder-body": ["20px", { lineHeight: "1.5" }],
        "elder-subheading": ["26px", { lineHeight: "1.3", fontWeight: "600" }],
        "elder-heading": ["32px", { lineHeight: "1.2", fontWeight: "700" }],
        "elder-cta": ["32px", { lineHeight: "1.2", fontWeight: "700" }],
      },
