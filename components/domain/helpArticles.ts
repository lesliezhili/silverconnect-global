  ...
  },
  {
    ...
    body: {
      en: [
        ...
        "Your rights: You can download a JSON archive of everything we hold about you from Settings → Privacy → 'Download my data'. You can permanently delete your account from the same page; this removes your profile, bookings, addresses, payment methods, family/emergency contacts, reviews you wrote, AI history, safety reports you filed and notifications. Disputes you raised are retained (with your identifier blanked) for 7 years per AU regulator requirements.",
      ...
      zh: [
        ...
        "您的权利：可在「设置 → 隐私」中点击「下载我的数据」，导出一份 JSON 存档；也可在同一页面永久注销账号，届时将删除您的资料、订单、地址、支付方式、家属/紧急联系人、您写过的评价、AI 历史、提交过的安全报告和通知。您发起的争议依澳洲监管要求保留 7 年（您的身份标识会被置空）。",
