  ...
  return (
    <Modal>
      <ModalTrigger asChild>
        <button
          type="button"
          className="inline-flex h-12 w-full items-center justify-center gap-1.5 rounded-md bg-brand px-3 text-[17px] font-bold text-white"
        >
      ...
      <ModalContent title={strings.title}>
        ...
        >
          ...
          <div>
            ...
            />
            {fileName && (
              <p className="mt-1 truncate text-[16px] text-text-tertiary">
                {fileName}
              </p>
            )}
          </div>
          <div className="mt-2 flex gap-3">
            <ModalClose
              type="button"
              className="inline-flex h-12 flex-1 items-center justify-center rounded-md border-[1.5px] border-border-strong bg-bg-base text-[16px] font-semibold text-text-primary"
            >
              {strings.cancel}
            </ModalClose>
