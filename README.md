# SilverConnect Global (和润 HeRun)

> 🌏 Non-profit mutual aid platform for elder care — connecting vulnerable seniors with dual-generation caregivers.

## 100% Free & Open-Source Stack

| Layer | Technology | Cost |
|-------|-----------|------|
| Framework | Next.js 16 (MIT) | Free |
| Database | PostgreSQL via Neon (0.5GB free) | Free |
| ORM | Drizzle ORM (MIT) | Free |
| Auth | iron-session + bcryptjs | Free |
| AI/LLM | Hugging Face Inference API (Mistral-7B) | Free tier |
| Push Notifications | ntfy.sh (open-source) | Free forever |
| Email | Resend (100/day free) or Nodemailer + Gmail | Free |
| Geocoding | OpenStreetMap Nominatim | Free |
| Payments | Stripe (pay-per-tx, non-profit discount) | Free until revenue |
| Hosting | Vercel Hobby | Free |
| CI/CD | GitHub Actions | Free |
| Monitoring | Vercel Analytics (free) | Free |

**Total monthly cost: $0** (until payment processing volume requires Stripe fees)
...
│  • Bilingual (EN/ZH) • Elder-first UI • PWA-ready  │
├─────────────────────────────────────────────────────┤
│  API Routes (Server Actions + Route Handlers)        │
│  • Auth (iron-session)  • Booking Engine            │
│  • AI Chat (HuggingFace) • Biography Engine         │
│  • Escrow (PHledger)    • Emergency Dispatch        │
├─────────────────────────────────────────────────────┤
│  Database (PostgreSQL / Neon)                        │
│  • Users • Providers • Bookings • Escrow            │
│  • PHledger (blockchain-style audit)                │
│  • Biography chapters • AI intent logs              │
├─────────────────────────────────────────────────────┤
│  External Services (all free)                        │
│  • ntfy.sh (push)  • Nominatim (geo)               │
│  • HuggingFace (AI) • Resend (email)               │
└─────────────────────────────────────────────────────┘
```
...
| # | Module | Status |
|---|--------|--------|
| 1 | Auth & User Profiles | ✅ Complete |
| 2 | Provider Onboarding & Availability | ✅ Complete |
| 3 | Customer Onboarding & Preferences | ✅ Complete |
| 4 | Booking Engine & Scheduling | ✅ Complete |
| 5 | Trust Escrow & PHledger | ✅ Complete |
| 6 | Intelligent Dispatch & Emergency Fallback | ✅ Complete |
| 7 | AI Service & Digital Autobiography | ✅ Complete |
...
cp .env.example .env.local  # Configure free services
npm install
...
1. **Basic Home Help** — cleaning, cooking, companionship
2. **Certified Care** — bathing, mobility, medication reminders
3. **Clinical Professional** — wound care, vitals monitoring, injections

## Countries & Languages

- 🇦🇺 Australia | 🇨🇳 China | 🇨🇦 Canada
- English (en) | 中文简体 (zh) | 中文繁體 (zh_tw) | 한국어 (ko) | 日本語 (ja) | ไทย (thai)
