...
export const countryEnum = pgEnum("country", ["AU", "CN", "CA", "US", "TW", "SG", "HK", "MY"]);
export const localeEnum = pgEnum("locale", ["en", "zh", "zh_tw", "ja", "ko", "th", "vi"]);
...
export const timeSlotEnum = pgEnum("time_slot", ["morning", "afternoon", "evening", "6am-9am", "9am-12pm", "12pm-3pm", "3pm-6pm", "6pm-9pm"]);
...
export const activeRoleEnum = pgEnum("active_role", [
  "customer",
  "provider",
  "helper",
  "admin",
